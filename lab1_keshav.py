...
my_name = "Keshav" # Change to your name
my_github_account = "https://github.com/keshavmakker/comp115.git" # Change to your GitHub account
my_hobby = "Motorcycles" # Change to your hobby
hours_coding_per_week = "2-3" # How many hours per week would you like to devote to learn coding?
...
# Tried it, it says index error and index out of range
